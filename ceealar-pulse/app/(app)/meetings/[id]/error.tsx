...
export default function MeetingDetailError({
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12 space-y-4">
      <h1 className="text-xl font-semibold">Couldn&apos;t load this meeting</h1>
      ...
      <div className="flex gap-2">
        ...
        <Link href="/meetings" className="text-sm border rounded-md px-3 py-1.5 hover:bg-muted transition-colors">
          Back to schedule
        </Link>
      </div>
    </div>
